...
GOOGLE_DRIVE_URL = 'https://drive.google.com/uc?id=1Y3AiSui-YEoqrt4pl1vXLeFhfyM0baxF'
DATA_URL = 'Motor_Vehicle_Collisions_-_Crashes.csv'

# Check if the file already exists, otherwise download it
if not os.path.isfile(DATA_URL):
    download_data(GOOGLE_DRIVE_URL, DATA_URL)
...
injured_people = st.slider("Number of persons injured in vehicle collisions", 0, 25)
